...
@SourceType(value = "AccessARP", label = "Access",uiConfig = "access-layout.json")
public class AccessConf extends AbstractArpConf<AccessConf> {
  private static final String ARP_FILENAME = "arp/implementation/access-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.access.AccessDriver";
